...
$agent_query = "SELECT fname, lname, phone_number, referral_code FROM users WHERE id = '$agent_id'";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['phone_number']) && isset($_POST['fname']) && isset($_POST['lname'])) {
        ...
        $update_query = "UPDATE users SET phone_number = '$new_phone_number', fname = '$new_fname', lname = '$new_lname' WHERE id = '$agent_id'";
...
<head>
    ...
    <title>Account Settings - Harbor Investment</title>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="fname" name="fname" 
                           value="<?php echo htmlspecialchars($agent['fname']); ?>" required>
                </div>
                <div class="form-group">
                    <label for="lname"><i class="fas fa-user"></i> Last Name</label>
                    <input type="text" class="form-control" id="lname" name="lname" 
                           value="<?php echo htmlspecialchars($agent['lname']); ?>" required>
                </div>
                <div class="form-group">
